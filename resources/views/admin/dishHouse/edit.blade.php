            ...
            <div class="row">
                ...
                <div class="col">
                    <div class="mb-3 row">
                        ...
                        <div class="col-lg-10 col-md-6 col-sm-12">
                            <input name="description" value="{{ $viewData['dishHouse']->getDescription() }}" type="text" class="form-control">
                        </div>
                    </div>
                </div>
            </div>
            <div class="row">
                ...
                <div class="col">
                    <div class="mb-3 row">
                        ...
                        <div class="col-lg-10 col-md-6 col-sm-12">
                            <input name="instructions" value="{{ $viewData['dishHouse']->getInstructions() }}" type="text" class="form-control">
                        </div>
                    </div>
                </div>
            </div>
